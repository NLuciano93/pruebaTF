...
{
    public class ShowAllUsersHandler : Handler<ShowAllUsersRequest, IPagination<RegistrationSummaryResponse>>
    {
        private readonly ILogger<ShowAllUsersHandler> _logger;
        private readonly IService _service;
        private readonly IMapper _mapper;

        public ShowAllUsersHandler(ILogger<ShowAllUsersHandler> logger, IService service, IMapper mapper)
        {
        ...
        public override async Task<Result<IPagination<RegistrationSummaryResponse>>> Handle(ShowAllUsersRequest request, CancellationToken cancellationToken)
        {
            try
            {
                var showAllUsersDto = _mapper.Map<ShowAllUsersDto>(request);

                showAllUsersDto.RoleId = (int)EnabledRoles.User;
