...
{
    public class ShowAllAdminsValidator : AbstractValidator<ShowAllAdminsRequest>
    {
        public ShowAllAdminsValidator()
        {
            RuleFor(x => x.Offset)
        ...
        protected override bool PreValidate(ValidationContext<ShowAllAdminsRequest> context, ValidationResult result)
        {
